...
4. **Create a command to shell into your `gatsby` service**
...
2. In your editor, open this file up and create the command.
...
3. From your project root run the new command:
